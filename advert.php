...
<div id = "registration-window">
    ...
    <form action="index.php" class = "top-row" id="registration-form" method="post" onsubmit="
        ...
        <label for="RegistrationName"></label><input name="name" placeholder="Введите ваше имя..." required autocomplete="on" pattern="[А-ЯЁа-яё]+$" id="RegistrationName"/>
...
<main>
    ...
    ?>
        <div class="advert">
            <div class="advert-title"><?= $row['name'] ?></div>
            <div class="advert-content">
                <div class="advert-photo">
                    <img src="<?= $row['photo'] ?>">
                </div>
                <div class="advert-text">
                    <div class="advert-description"><?= $row['description'] ?></div>
                    <div class="advert-bottom-text">
                        <div class="advert-price">Цена: <?= $row['price'] ?> рублей</div>
                        <div class="advert-phone">Телефон продавца: <?= $row['user_phone'] ?></div>
                    </div>
                </div>
            </div>
        </div>
